...
-- construct status bar per screen 
promptbox = {}
layoutbox = {}
taglist = {}
taskbar = {}
...
-- create each component per screen
for s = 1, screen.count() do
    -- Prompt box application launcher
